...
AddEventHandler("playerSpawned", function(spawn)
  ...
  Citizen.CreateThread(function()
      ...
      AddTextComponentString("Bienvenue sur le serveur ~g~tropsupercool !.\n");
      SetNotificationMessage("CHAR_ALL_PLAYERS_CONF", "CHAR_ALL_PLAYERS_CONF", true, 1, "Discord: ", "monadressediscord");
