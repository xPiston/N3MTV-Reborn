	...
	menu = {
		...
		["Melee"] = {
			...
			buttons = {
				...
				{title = "Golfclub", name = "Golfclub", costs = 13000, description = {}, model = "WEAPON_Golfclub"},
		...
		["Pistolets"] = {
			...
			buttons = {
				...
				{title = "Heavy Pistol", name = "HeavyPistol", costs = 47000, description = {}, model = "WEAPON_HeavyPistol"},
				...
				{title = "Revolver", name = "Revolver", costs = 32000, description = {}, model = "WEAPON_Revolver"},
				{title = "AP Pistol", name = "APPistol", costs = 61000, description = {}, model = "WEAPON_APPistol"},
